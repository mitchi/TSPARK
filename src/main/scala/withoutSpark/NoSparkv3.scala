...
object NoSparkv3 extends Serializable {
...
object testNoSparkv3 extends App {

  import NoSparkv3.withoutSpark

  val conf = new SparkConf().setMaster("local[*]").
    setAppName("Without Spark v3")
  ...
  println("Without Spark Version 3")
