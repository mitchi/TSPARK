...
import generator.gen.{filename, horizontalgrowth_1percent, save, updateTestColoring}
import org.apache.spark.SparkContext
import org.apache.spark.storage.StorageLevel
import utils.utils.saveTestSuite
import utils.utils

object distributed_ipog {
  ...
  /**
    ...
    * @return
    */
  def parallel_ipogm(n: Int, t: Int, v: Int, sc: SparkContext,
